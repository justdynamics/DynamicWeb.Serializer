...
// Execution requires:
//   1. Build: dotnet build src/DynamicWeb.Serializer/ -c Debug
//   2. Copy DLLs to Swift2.1 bin:
//        copy src\DynamicWeb.Serializer\bin\Debug\net8.0\DynamicWeb.Serializer.dll
...
//   4. Run: dotnet test tests/DynamicWeb.Serializer.IntegrationTests/ --filter "Category=Integration"
...
namespace DynamicWeb.Serializer.IntegrationTests.Deserialization;
