...
/// (<c>src/Truvio.Commerce.Serializer/Configuration/swift2.2-combined.json</c>) through
...
public class Swift22BaselineRoundTripTests
{
    ...
    {
        // Tests/Truvio.Commerce.Serializer.Tests/bin/Debug/net8.0 → walk up to repo root → Configuration
        var path = Path.Combine(
            AppContext.BaseDirectory,
            "..", "..", "..", "..", "..",
            "src", "Truvio.Commerce.Serializer", "Configuration", "swift2.2-combined.json");
