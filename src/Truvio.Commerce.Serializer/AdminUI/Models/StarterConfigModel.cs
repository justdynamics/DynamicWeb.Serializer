...
public sealed class StarterConfigModel : DataViewModelBase
{
    ...
    public string Summary { get; set; } =
        "Writes the Swift starter configuration: the platform-wired site pages use replace (checkout, customer center, " +
        "service pages, commerce framework tables), the customer-owned content surfaces use merge (Home, About, blog, " +
